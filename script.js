...
class Notepad {
    constructor() {
        ...
        this.calPrevBtn.addEventListener('click', () => { this.calMonth--; if (this.calMonth < 0) { this.calMonth = 11; this.calYear--; } this.renderCalendar(); });
        this.calNextBtn.addEventListener('click', () => { this.calMonth++; if (this.calMonth > 11) { this.calMonth = 0; this.calYear++; } this.renderCalendar(); });
        this.calClearBtn.addEventListener('click', () => { this.filterDate = null; this.calClearBtn.hidden = true; this.renderCalendar(); this.renderList(); });
    ...
    renderCalendar() {
        ...
        for (let d = 1; d <= daysInMonth; d++) {
            ...
            html += `<div class="${cls}" data-key="${key}" data-clickable="${hasNote}">${d}</div>`;
        }
